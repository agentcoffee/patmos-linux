...
void foo(void)
{
    OFFSET(REG_R0,      pt_regs, r0);
    OFFSET(REG_R1,      pt_regs, r1);
    OFFSET(REG_R2,      pt_regs, r2);
    OFFSET(REG_R3,      pt_regs, r3);
    OFFSET(REG_R4,      pt_regs, r4);
    OFFSET(REG_R5,      pt_regs, r5);
    OFFSET(REG_R6,      pt_regs, r6);
    OFFSET(REG_R7,      pt_regs, r7);
    OFFSET(REG_R8,      pt_regs, r8);
    OFFSET(REG_R9,      pt_regs, r9);
    OFFSET(REG_R10,     pt_regs, r10);
    OFFSET(REG_R11,     pt_regs, r11);
    OFFSET(REG_R12,     pt_regs, r12);
    OFFSET(REG_R13,     pt_regs, r13);
    OFFSET(REG_R14,     pt_regs, r14);
    OFFSET(REG_R15,     pt_regs, r15);
    OFFSET(REG_R16,     pt_regs, r16);
    OFFSET(REG_R17,     pt_regs, r17);
    OFFSET(REG_R18,     pt_regs, r18);
    OFFSET(REG_R19,     pt_regs, r19);
    OFFSET(REG_R20,     pt_regs, r20);
    OFFSET(REG_R21,     pt_regs, r21);
    OFFSET(REG_R22,     pt_regs, r22);
    OFFSET(REG_R23,     pt_regs, r23);
    OFFSET(REG_R24,     pt_regs, r24);
    OFFSET(REG_R25,     pt_regs, r25);
    OFFSET(REG_R26,     pt_regs, r26);
    OFFSET(REG_R27,     pt_regs, r27);
    OFFSET(REG_R28,     pt_regs, r28);
    OFFSET(REG_R29,     pt_regs, r29);
    OFFSET(REG_R30,     pt_regs, r30);
    OFFSET(REG_R31,     pt_regs, r31);

    OFFSET(PREDS,       pt_regs, preds);

    OFFSET(SPR_R0,      pt_regs, s0);
    OFFSET(SPR_R1,      pt_regs, s1);
    OFFSET(SPR_R2,      pt_regs, s2);
    OFFSET(SPR_R3,      pt_regs, s3);
    OFFSET(SPR_R4,      pt_regs, s4);
    OFFSET(SPR_R5,      pt_regs, s5);
    OFFSET(SPR_R6,      pt_regs, s6);
    OFFSET(SPR_R7,      pt_regs, s7);
    OFFSET(SPR_R8,      pt_regs, s8);
    OFFSET(SPR_R9,      pt_regs, s9);
    OFFSET(SPR_R10,     pt_regs, s10);
    OFFSET(SPR_R11,     pt_regs, s11);
    OFFSET(SPR_R12,     pt_regs, s12);
    OFFSET(SPR_R13,     pt_regs, s13);
    OFFSET(SPR_R14,     pt_regs, s14);
    OFFSET(SPR_R15,     pt_regs, s15);
